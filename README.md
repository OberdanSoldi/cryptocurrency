...
###### A project about requesting data from a cryptocurrency API.

Project made with HTML and JavaScript using the [CoinMarketCap](https://pro.coinmarketcap.com/) website API with the [Moesif CORS](https://www.moesif.com/) extension.
